...
![](https://i.imgur.com/E2Gu7ke.png){fig-align="center"}
...
# Setup axis
axis_x <- seq(min(Milk$Neocortex), max(Milk$Neocortex), by = graph_reso)
axis_y <- seq(min(Milk$log_Mass), max(Milk$log_Mass), by = graph_reso)
