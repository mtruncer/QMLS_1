...
- 1 categorical variable (factor) with two levels
    - Internally re-coded as 0 and 1
- One level is the *reference* level
    - Default is the alphabetically first
...
if (FALSE) {
  ...
  qsave(x = samples, file = "../data/bayes_model_HL.qs")
}

# Read the posterior samples from the saved qs file.
post <- qread("../data/bayes_model_HL.qs")
