...
<center><img src="https://i.imgur.com/fHQecxu.png" width="35%" />
<br />
<br />
</center>  
...
```{r eval=FALSE}
MM$log10_WnMass <- log10(MM$WnMass)
MM$sqrt_WnMass <- sqrt(MM$WnMass)
```
...
```{r warning=FALSE}
M_agr <- aggregate(MM, by = list(MM$DamID), FUN = "mean")
M_agr
```
