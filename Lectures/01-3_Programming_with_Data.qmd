...
- People have extended the basic R functionality
...
![](https://www.leonardodavinci.net/images/drawings/design-for-a-flying-machine.jpg){fig-align="center"}
...
Tibbles and `data.frame`s are essentially identical, but a tibble is more modern and works better with the data structure of the tidyverse.  For more detailed info see `vignette("tibble")`.
