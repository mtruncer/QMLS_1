...
How do we model the relationship between rainfall and leaf area?
...
<center>
<img src="https://i.imgur.com/F0Y5Fva.png" width="100%" />
</center>
...
p + 
  geom_abline(slope = 2.3, intercept = 0, color = "blue") +
  geom_abline(slope = 1.4, intercept = 10, color = "grey50") +
  geom_abline(slope = 2.0, intercept = 2, color = "grey50") +
  geom_abline(slope = 3.5, intercept = -10, color = "grey50") 
...
- sd can be calculated based on the variance of $Y$.
...
- Search a range of values for $\theta_0$
