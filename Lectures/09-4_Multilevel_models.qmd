...
$$Y = \beta_0 + \beta_1 X_1 + ... + \beta_n X_n + \mbox{Random} + \epsilon$$
...
ggplot(all_data_long,
       aes(x = Group, y = Absorbance, group = Sample, color = Replicate)) +
  geom_point(position = position_dodge(width = 0.75),
             size = 4) +
  paletteer::scale_color_paletteer_d(palette = "nbapalettes::suns_00s") +
