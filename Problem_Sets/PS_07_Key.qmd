...
Second, calculate an *exact* ~95% confidence interval for each mean (cotton & corn groups), using the formula discussed in lecture $\mu$ +/- 2 * SEM.
...
Reading other people's code and interpreting it is a cricial skill that you will want to develop. Study the code below before you execute it. Make sure you understand all the lines. Confirm your understanding by adding your own comments to the code at the "#"s.
...
## Exact confidence intervals for proportions FIXME FIXME
