...
Execute the chunk above and look at the R console output. Explain what we have done here and what R must be doing without telling you. Write your answer after the ">" below. (">"" is the qmd for a block quote, which will make finding your answers easier.)
