...
# The stringr package, which is loaded with tidyverse, has a function
# str_to_upper() that we can use as well, because we just want to convert
# f and m to uppercase.
SSD <- SSD |> 
...
# And with tidyverse using str_replace
SSD <- SSD |> 
